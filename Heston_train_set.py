...
for i in range(N_sample):
  ...
  # if heston_price[i]<0:
  #   print('maturity_date {},strike {}, interest {}, divident {},kappa_ {}, rho_ {}, theta_ {},v_0 {},ita_ {},price {}'.format(
  #         mat_data_range[i],strike_price,risk_free_rate,dividend_rate,kappa,rho,theta,v0,ita,heston_price[i]))
  #   break
